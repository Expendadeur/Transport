...
// Fetch Reservations with Passenger and Trajet info
$query = "SELECT r.*, p.nomP as passager_nom, p.prenomP as passager_prenom, t.ville_depart, t.ville_arrive, pay.montant as pay_montant, pay.statut as pay_statut 
          FROM reservation r 
                        ...
                        <tr>
                            ...
                            <td style="text-align: right;">
                                <div style="display: flex; gap: 0.5rem; justify-content: flex-end;">
                                    <a href="edit.php?id=<?php echo $r['idRes']; ?>" class="btn" style="background: #f1f5f9; color: #0f172a; padding: 0.5rem;"><i class="fas fa-edit"></i></a>
                                    <button onclick="confirmDelete('delete.php?id=<?php echo $r['idRes']; ?>')" class="btn" style="background: #fee2e2; color: #ef4444; padding: 0.5rem;"><i class="fas fa-trash"></i></button>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
